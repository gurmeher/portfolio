...
function ProjectImage({ src, alt }: ProjectImageProps) {
  return (
    ...
    >
      ...
      <MorphingDialogContainer>
        <MorphingDialogContent className="relative rounded-2xl bg-zinc-50 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-900 dark:ring-zinc-800/50">
          <Image
            src={src}
            alt={alt}
            width={1920}
    ...
    >
      ...
      >
        <div className="flex-1">
          ...
          Interested in SWE, Data, AI, and Startups. Actively seeking internship opportunities in these areas for Fall 2026, Spring & Summer 2027!
          <br /><br />Outside of tech, I'm a swimmer and a new cyclist (just got a road bike!), with a goal of completing a half Ironman.
          ...
          As a big car enthusiast, I love working on and driving cars (Nerdy fun fact: I keep a list of every car I've driven — currently at 33!), and talking about anything automotive.
          </p>
        </div>
      </motion.section>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {PROJECTS.map((project) => (
            <div key={project.name} className="space-y-2">
              <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-[#111111] dark:ring-zinc-400/50">
